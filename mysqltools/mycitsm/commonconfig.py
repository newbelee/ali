...
##获取db负责人接口
base_module_leader_url = 'http://ops.yonghuivip.com'
#根据用户确认db owner
module_leader_url = '%s/%s' % (base_module_leader_url, 'tools/getuserdata')

def get_dbowner(username, dbname):
    params = {'user':username, 'db_name':dbname}
    r = requests.get(module_leader_url, params=params)
